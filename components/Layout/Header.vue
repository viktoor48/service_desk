...
const NavStyleArr: Map<string, string> = new Map([['dark', 'bg-white'], ['default', 'bg-black']])
const LogoArr: Map<string, any> = new Map([['dark', LogoBlack], ['default', Logo]])
...
<template>
  <header class="sticky top-0 z-10 w-full px-5 lg:px-10" :class="getStyle()">
    <div class="relative z-10 flex h-16 grid-cols-header content-center items-center justify-between border-b lg:grid lg:h-24" :class="getStyle()">
    ...
    >
      <div class="flex flex-auto flex-col gap-5 py-5 md:grid md:grid-cols-2 md:py-10">
        <nav>
          <ul
